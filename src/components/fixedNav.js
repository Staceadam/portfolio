...
class FixedNav extends Component {
	...
	onNavClick(event) {
		...
		new Map([
			...
			['projects-link', '.section-projects'],
	...
	render() {
		return (
			<div className="fixedNav">
				<div className="row">
					<div className="name">
						<a target="_blank" href="http://www.github.com/Staceadam">
							Stacy Adam
						</a>
					</div>
					<ul className={this.state.open}>
						<li>
							<a className="about-link" onClick={this.onNavClick} href="#about">
								About
							</a>
						</li>
						<li>
							<a className="projects-link" onClick={this.onNavClick} href="#projects">
								Projects
							</a>
						</li>
						<li>
							<a target="_blank" href="https://medium.com/@staceadam">
								Blog
							</a>
						</li>
						<li>
							<a className="contact-link" onClick={this.onNavClick} href="#contact">
								Contact
							</a>
						</li>
					</ul>
					<div className={this.state.fixed} onClick={this.onHamClick}>
