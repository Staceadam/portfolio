...
const projectData = [
...

    {
        ...
        link: {
            title: "iOS App Store",
            href:
                "https://apps.apple.com/us/app/ssu/id521587305?app=itunes&ign-mpt=uo%3D4"
        }
    },
    {
    ...
    },
    {
        ...
        features: [
            "Used best practices for node architecture.",
            "Created Postgres DB instance."
        ],
        link: {
...
const Projects = () => {
    ...
    const Project = ({ name, platform, className, index }) => {
        return (
            <a
                className={`projects-item ${className}`}
                onClick={() => findAndSetModal(index)}
            >
